...
export default function ActionBar({ onAddClick, onDeleteAll, onDeleteSelected, isSelectionMode, onEnterSelectionMode, onExitSelectionMode, selectedCount }: ActionBarProps) {
